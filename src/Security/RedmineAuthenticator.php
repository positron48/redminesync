...
class RedmineAuthenticator extends AbstractFormLoginAuthenticator
{
    use TargetPathTrait;
    ...
    public function getUser($credentials, UserProviderInterface $userProvider)
    {
        ...
        $user = $this->entityManager->getRepository(RedmineUser::class)->findOneBy(['username' => $credentials['username']]);
